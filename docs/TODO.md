...
- [ ] F06 Implement the three firearm verbs and puzzle interactions.
- [ ] F07 Produce temple room kit and ceramic emergence art.
- [ ] F08 Implement one ceramic encounter and persistence contract.
- [ ] F09 Produce adult Keeper identity/portrait package and branching dialogue plan.
- [ ] F10 Implement checkpoint and relationship states without progression dependence on romance.
- [ ] F11 Produce mural/pit enemy packs and Recall to Clay presentation.
- [ ] F12 Integrate the bounded temple route, resettable puzzles and alternate exit route.
